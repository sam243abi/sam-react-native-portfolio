...
export default function WashIronOverlay({ visible, onClose, data, onAddToCart, onSchedule, editMode = false, editData = null, onSaveChanges }) {
...
const styles = StyleSheet.create({
    ...
    overlayContent: { backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: '90%', minHeight: '70%', },
    ...
    quantityCard: { backgroundColor: '#fff', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#f0f0f0' },
    ...
    optionsCard: { backgroundColor: '#fff', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#f0f0f0' },
    ...
    noteCard: { backgroundColor: '#fff', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#f0f0f0' },
    overlayBottom: { 
        padding: 20, 
